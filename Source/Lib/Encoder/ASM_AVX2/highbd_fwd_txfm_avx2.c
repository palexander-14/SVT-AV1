    ...
    for (r = 0; r < row_size; r += 8) {
        for (c = 0; c < col_size; c++) {
            transpose_32_8x8_avx2(
                col_size, &input[r * col_size + c], &output[c * 8 * col_size + r / 8]);
        }
    }
}
...
static INLINE __m128i half_btf_small(const __m128i *w0, const __m128i *n0, const __m128i *w1,
...
#define btf_32_avx2_type1(w0, w1, in0, in1, out0, out1, bit) \
    do { btf_32_avx2_type0(w1, w0, in1, in0, out0, out1, bit); } while (0)
...
static INLINE void load_buffer_8x8(const int16_t *input, __m256i *in, int32_t stride,
...
static INLINE void load_buffer_4x4_avx2(const int16_t *input, __m256i *in, int32_t stride,
    ...
    if (!flipud) {
        in[0] = _mm256_setr_epi64x(
            *(uint64_t *)(input + 0 * stride), *(uint64_t *)(input + 1 * stride), 0, 0);
        in[1] = _mm256_setr_epi64x(
            *(uint64_t *)(input + 2 * stride), *(uint64_t *)(input + 3 * stride), 0, 0);
    } else {
        in[0] = _mm256_setr_epi64x(
            *(uint64_t *)(input + 3 * stride), *(uint64_t *)(input + 2 * stride), 0, 0);
        in[1] = _mm256_setr_epi64x(
            *(uint64_t *)(input + 1 * stride), *(uint64_t *)(input + 0 * stride), 0, 0);
    }
...
static INLINE void load_buffer_4x8_avx2(const int16_t *input, __m256i *out, int32_t stride,
                                        int32_t flipud, int32_t fliplr, int32_t shift) {
...
static INLINE void load_buffer_8x4_avx2(const int16_t *input, __m256i *out, int32_t stride,
                                        int32_t flipud, int32_t fliplr, int32_t shift) {
    const int16_t *top_l = input;
...
static INLINE void load_buffer_4x16_avx2(const int16_t *input, __m256i *out, const int32_t stride,
                                         const int32_t flipud, const int32_t fliplr,
                                         const int32_t shift) {
    const int16_t *top_l = input;
...
static INLINE void load_buffer_16x4_avx2(const int16_t *input, __m256i *out, int32_t stride,
                                         int32_t flipud, int32_t fliplr, int32_t shift) {
    const int16_t *top_l = input;
...
void eb_av1_fwd_txfm2d_8x8_avx2(int16_t *input, int32_t *coeff, uint32_t stride, TxType tx_type,
                                uint8_t bd) {
    __m256i       in[8], out[8];
...
static INLINE void load_buffer_16x16(const int16_t *input, __m256i *out, int32_t stride,
                                     int32_t flipud, int32_t fliplr, int32_t shift) {
    __m256i in[32];
    // Load 4 8x8 blocks
    const int16_t *top_l = input;
...
void eb_av1_fwd_txfm2d_16x16_avx2(int16_t *input, int32_t *coeff, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
...
static void av1_fdct32_new_avx2(const __m256i *input, __m256i *output, int8_t cos_bit,
...
static void av1_fdct64_new_avx2(const __m256i *input, __m256i *output, int8_t cos_bit,
                                const int32_t col_num, const int32_t stride) {
    const int32_t *cospi      = cospi_arr(cos_bit);
    const __m256i  __rounding = _mm256_set1_epi32(1 << (cos_bit - 1));
    const int32_t  columns    = col_num >> 3;
...
typedef void (*TxfmFuncAVX2)(const __m256i *input, __m256i *output, const int8_t cos_bit,
...
static INLINE void fidtx4x8_row_avx2(__m256i *input, __m256i *output, int32_t bit,
                                     int32_t col_num) {
    (void)bit;
    __m256i in[4];
    __m256i out[4];
...
static void fidtx32x32_avx2(const __m256i *input, __m256i *output, const int8_t cos_bit,
                            const int8_t *stage_range) {
    (void)stage_range;
...
void eb_av1_fwd_txfm2d_32x32_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
...
void eb_av1_fwd_txfm2d_64x64_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    (void)bd;
    __m256i       in[512];
...
static INLINE void load_buffer_32_avx2(const int16_t *input, __m256i *in, int32_t stride,
                                       int32_t flipud, int32_t fliplr, int32_t shift) {
    __m128i temp[4];
    if (!flipud) {
        temp[0] = _mm_loadu_si128((const __m128i *)(input + 0 * stride));
...
static INLINE void load_buffer_16_avx2(const int16_t *input, __m256i *in, int32_t stride,
                                       int32_t flipud, int32_t fliplr, int32_t shift) {
    __m128i temp[2];
    if (!flipud) {
        temp[0] = _mm_loadu_si128((const __m128i *)(input + 0 * stride));
...
void eb_av1_fwd_txfm2d_32x64_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    (void)tx_type;
    __m256i       in[256];
...
void eb_av1_fwd_txfm2d_64x32_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    (void)tx_type;
    __m256i       in[256];
    __m256i *     outcoef256    = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_16x64_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    __m256i       in[128];
    ...
    for (int32_t i = 0; i < txfm_size_row; i += num_col) {
        load_buffer_16_avx2(
            input + (i + 0) * stride, in + (i + 0) * num_col, 8, ud_flip, lr_flip, shift[0]);
        load_buffer_16_avx2(
            input + (i + 1) * stride, in + (i + 1) * num_col, 8, ud_flip, lr_flip, shift[0]);
    }
...
void eb_av1_fwd_txfm2d_64x16_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    __m256i       in[128];
    __m256i *     outcoeff256   = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_16x32_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    __m256i                  in[64];
    __m256i *                outcoef256    = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_32x16_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                  uint8_t bd) {
    __m256i                  in[64];
    __m256i *                outcoef256    = (__m256i *)output;
...
/* call this function only for DCT_DCT, IDTX */
void eb_av1_fwd_txfm2d_8x32_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                 uint8_t bd) {
    __m256i                  in[32];
    __m256i *                outcoef256 = (__m256i *)output;
...
/* call this function only for DCT_DCT, IDTX */
void eb_av1_fwd_txfm2d_32x8_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                 uint8_t bd) {
    __m256i                  in[32];
    __m256i *                outcoef256 = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_8x16_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                 uint8_t bd) {
...
void eb_av1_fwd_txfm2d_4x8_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                uint8_t bd) {
    __m256i in[4];
...
void eb_av1_fwd_txfm2d_8x4_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                uint8_t bd) {
    __m256i       in[4];
    __m256i *     outcoeff256 = (__m256i *)output;
...
void eb_av1_fwd_txfm2d_4x16_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                 uint8_t bd) {
    __m256i       in[8];
...
void eb_av1_fwd_txfm2d_16x4_avx2(int16_t *input, int32_t *output, uint32_t stride, TxType tx_type,
                                 uint8_t bd) {
    __m256i       in[8];
    __m256i *     outcoeff256 = (__m256i *)output;
